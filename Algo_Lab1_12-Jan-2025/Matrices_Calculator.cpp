...
int main(){
    ...
    cout << "Number of Row for Matrix B: ";
    cin >> row2;
    cout << "Number of Column for Matrix B: ";
    cin >> col2;
    ...
    cout << "Please Enter a Operator (For Addition '+'; For Subtraction '-'; For Multiplication '*' )" << endl;
    cin >> x;
    ...
    if(x == '+'){
     ...
     else if(x == '-')
     {
        ...
        cout << "ERROR! You Entered Wrong Operator Sign." << endl;
    }
